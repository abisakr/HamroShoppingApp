    ...
    <div className='container mx-auto px-4 my-6 relative'>
      ...
      <div className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
        ...
        {loading ? (
          ...
          data.map((product) => (
            <Link to={`product/${product?.id}`} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex' key={product?.id}>
              ...
              <div className='p-2 grid'>
                ...
                <div>
                  <p className='text-red-600 font-medium'>{ displayINRCurrency(product?.price-110) }</p>
