...
const UploadProduct = ({
    ...
    const [data, setData] = useState({
        productName: "",
        categoryId: "",
        photo: "", // Only store one photo as a string
        description: "",
        price: "",
        discount: "",
        stockQuantity: "",
    ...
    const handleUploadProduct = async (e) => {
        ...
        setData((prev) => ({
            ...prev,
            photo: uploadImageCloudinary.url // Store only one photo
        }));
    };
        ...
        <div className='fixed w-full  h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
            <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
                ...
                <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
                    ...
                    <select required value={data.categoryId} name='categoryId' onChange={handleOnChange} className='p-2 bg-slate-100 border rounded'>
